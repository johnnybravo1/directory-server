...
rem Portions Copyright 2011-2018 ForgeRock AS.
...
"%OPENDJ_JAVA_BIN%" -client org.opends.server.tools.ConfigureWindowsService --stopService
goto end
...
"%OPENDJ_JAVA_BIN%" -client org.opends.server.tools.ConfigureWindowsService --startService
